        ...
        <div className="container">
          <div className="row align-items-center min-vh-100">
            <div className="col-md-6">
              <img src={home} className="w-100 mt-5 pt-5" alt="Home FITUS" />
            </div>
            <div className="col-md-6 text-center text-md-left mb-4">
              <span className="home__subtitle">Challange Your Limits</span>
              <h3 className="home__title pt-2">Stay with FITUS</h3>
              <Link to="/login">
                <Button title="Member" />
              </Link>
